...
export default function PaymentModal({ isOpen, setIsOpen, price}) {
  ...
  const launchRazorPay =() => {
      let options ={
          key: "rzp_test_M6lceu6iphJas0",
          amount: price * 100,
          currency: "INR",
          name: "Book My Show Clone",
          description: "Movie Purchase or Rental",
          image: "https://e7.pngegg.com/pngimages/919/445/png-clipart-bookmyshow-office-android-ticket-android-text-logo-thumbnail.png",
          handler: () => {
              setIsOpen(false);
              alert("Payment Done");
          },
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="w-full mt-4">
                  ...
                  <button
                    type="button"
                    className="mt-3 w-full inline-flex justify-center px-4 py-2 text-sm font-medium text-red-700 bg-white-600 border border-transparent rounded-md hover:bg-red-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white-500"
                    onClick={closeModal}
                  >
                    Cancel Payment
                  </button>
